...
#define PS2_WAIT_TIME           1000  // In milliseconds
...
#define ps2_print_read_buffer() { kprintf("PS/2 read buffer : "); for (uint8_t i = 0; i < ps2_data_bytes_received; i++) kprintf("0x%x ", ps2_data_buffer[i]); kputchar('\n'); }
