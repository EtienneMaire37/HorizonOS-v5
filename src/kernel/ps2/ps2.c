...
//         // LOG(DEBUG, "Status reg : 0x%llx", reg); 
...
//     // LOG(TRACE, "Sending command 0x%llx to PS/2 controller", command);
...
//     // LOG(TRACE, "Sending command 0x%llx, 0x%llx to PS/2 controller", command, data);
...
//     // LOG(TRACE, "Sending command 0x%llx to PS/2 device %u", command, device);
...
//     {
//         LOG(ERROR, "Controller self-test failed (code 0x%llx)", self_test_code);
